...
$stmt = $pdo->prepare("INSERT INTO members (first_name, last_name, jersey_number, position, phone, email, team_name) VALUES (?, ?, ?, ?, ?, ?, ?)");
$stmt->execute([$first, $last, $jersey, $position, $phone, $email, $team]);
